...
export function Navbar({ user, authUser, loading, onLoginClick, onMenuClick, onLogoClick }: NavbarProps) {
  return (
        ...
        {loading ? (
          ...
          >
            <img 
              ...
              alt={user?.name || authUser.displayName || authUser.email || 'Profile'}
