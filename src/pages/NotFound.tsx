...
export function NotFound() {
  ...
  return (
    <section className="bg-white p-4 sm:p-10 lg:p-12 rounded-3xl shadow-xl flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-6 md:gap-2 border border-slate-100 min-h-[300px] md:min-h-[390px]">
