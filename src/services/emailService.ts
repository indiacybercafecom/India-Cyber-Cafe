  ...
  <div style="background: #f8f9fa; padding: 25px 20px; margin-top: 30px; border-top: 3px solid #FF9933; text-align: center; font-size: 12px; color: #666; border-radius: 0 0 10px 10px;">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; text-align: left; max-width: 400px; margin: 0 auto 15px;">
      ...
      <div>
        ...
        <p style="margin: 0;"><a href="https://b.indiacybercafe.com" style="color: #FF9933; text-decoration: none;">b.indiacybercafe.com</a></p>
      </div>
    </div>
    ...
    <p style="margin: 10px 0 0 0; color: #999; font-size: 10px;">© 2024-2026 India Cyber Cafe. All rights reserved. | <a href="https://b.indiacybercafe.com/legal/privacy" style="color: #FF9933; text-decoration: none;">Privacy Policy</a></p>
  </div>
`;
...
export const emailTemplates = {
  ...
  registration: (name: string) => baseTemplate(
    ...
    `
      ...
      <p><a href="https://b.indiacybercafe.com/login" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">Login to Your Account</a></p>
  ...
  applicationSubmitted: (name: string, serviceName: string, appId: string) => baseTemplate(
    ...
    `
      ...
      <p><a href="https://b.indiacybercafe.com/track?id=${appId}" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">Track Your Application</a></p>
  ...
  statusUpdate: (name: string, serviceName: string, status: string, statusColor: string = '#FF9933') => baseTemplate(
    ...
    `
      ...
      <p><a href="https://b.indiacybercafe.com/profile" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">View Your Dashboard</a></p>
  ...
  noteAdded: (name: string, serviceName: string, note: string) => baseTemplate(
    ...
    `
      ...
      <p><a href="https://b.indiacybercafe.com/profile" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">Check Your Dashboard</a></p>
      <p>Best Regards,<br/><strong>India Cyber Cafe Team</strong></p>
    `
  ),
  ...
  profileUpdated: (name: string, updateType: string) => baseTemplate(
    ...
    `
      ...
      <p><a href="https://b.indiacybercafe.com/profile" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">View Your Profile</a></p>
      <p>Best Regards,<br/><strong>India Cyber Cafe Team</strong></p>
    `
  ),
  ...
  userPasswordDelivery: (name: string, password: string) => baseTemplate(
    ...
    `
      ...
      <ol style="color: #555; line-height: 1.8;">
        <li><strong>Login:</strong> Use your email/phone and this password to login at <a href="https://b.indiacybercafe.com/login" style="color: #FF9933;">b.indiacybercafe.com/login</a></li>
      ...
      <p style="margin-top: 20px;"><a href="https://b.indiacybercafe.com/login" style="background: #FF9933; color: white; padding: 12px 30px; border-radius: 5px; text-decoration: none; display: inline-block; font-weight: bold;">Login to Your Account</a></p>
      
      <p style="margin-top: 20px; color: #666; font-size: 13px;">If you need any help, please contact our support team at <a href="mailto:icc@indiacybercafe.com" style="color: #FF9933;">icc@indiacybercafe.com</a> or visit <a href="https://b.indiacybercafe.com" style="color: #FF9933;">b.indiacybercafe.com</a></p>
  ...
  paymentReceived: (name: string, amount: string, serviceName: string, transactionId: string) => baseTemplate(
    ...
    `
      ...
      <p><a href="https://b.indiacybercafe.com/profile" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">View Your Applications</a></p>
  ...
  applicationCompleted: (name: string, serviceName: string, appId: string, completionDetails?: string) => baseTemplate(
    ...
    `
      ...
      <p><a href="https://b.indiacybercafe.com/track?id=${appId}" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">Download Certificate/Documents</a></p>
  ...
  applicationRejected: (name: string, serviceName: string, appId: string, reason?: string) => baseTemplate(
    ...
    `
      ...
      <p><a href="https://b.indiacybercafe.com/profile" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">Update Your Application</a></p>
  ...
  adminNewApplication: (userName: string, userEmail: string, serviceName: string, appId: string) => baseTemplate(
    ...
    `
      ...
      <p><a href="https://b.indiacybercafe.com/admin" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">Review in Admin Panel</a></p>
  ...
  adminUserRegistered: (name: string, email: string, phone: string, registrationDate: string) => baseTemplate(
    ...
    `
      ...
      <p><a href="https://b.indiacybercafe.com/admin" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">View User Details</a></p>
      <p>Best Regards,<br/><strong>India Cyber Cafe System</strong></p>
    `
  ),
  ...
  operatorNewAssignment: (operatorName: string, userName: string, userEmail: string, serviceName: string, appId: string) => baseTemplate(
    ...
    `
      ...
      <p><a href="https://b.indiacybercafe.com/operator" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">View Assignment in Operator Panel</a></p>
  ...
  operatorAssignmentUpdated: (operatorName: string, serviceName: string, appId: string, newStatus: string, updateNote?: string) => baseTemplate(
    ...
    `
      ...
      <p><a href="https://b.indiacybercafe.com/operator" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">View in Operator Panel</a></p>
      <p>Best Regards,<br/><strong>India Cyber Cafe System</strong></p>
    `
  ),
  ...
  storeOrderConfirmation: (customerName: string, orderId: string, items: Array<{name: string, quantity: number, price: number}>, totalAmount: number, paymentMethod: string) => baseTemplate(
    ...
    `
      ...
      <p style="margin-top: 20px; text-align: center;">
        <a href="https://b.indiacybercafe.com" style="background: #FF9933; color: white; padding: 12px 30px; border-radius: 5px; text-decoration: none; display: inline-block; font-weight: bold;">Track Your Order</a>
      </p>
  ...
  guestAccountWelcome: (customerName: string, email: string, tempPassword: string) => baseTemplate(
    ...
    `
      ...
      <ol style="color: #555; line-height: 1.8; padding-left: 20px;">
        <li>Visit <a href="https://b.indiacybercafe.com/login" style="color: #FF9933;">b.indiacybercafe.com/login</a></li>
      ...
      <p style="margin-top: 20px;">
        <a href="https://b.indiacybercafe.com/login" style="background: #FF9933; color: white; padding: 12px 30px; border-radius: 5px; text-decoration: none; display: inline-block; font-weight: bold;">Log In to Your Account</a>
      </p>
  ...
  adminStoreOrder: (
    ...
    `
      ...
      <p style="margin-top: 20px;">
        <a href="https://b.indiacybercafe.com/admin" style="background: #FF9933; color: white; padding: 12px 30px; border-radius: 5px; text-decoration: none; display: inline-block; font-weight: bold;">View in Admin Panel</a>
      </p>
  ...
  orderStatusUpdate: (customerName: string, orderId: string, status: string, productName: string, estimatedDelivery?: string) => baseTemplate(
    ...
    `
      ...
      <p style="margin-top: 20px;">
        <a href="https://b.indiacybercafe.com" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">Track Your Order</a>
      </p>
  ...
  reviewSubmitted: (customerName: string, productName: string) => baseTemplate(
    ...
    `
      ...
      <p style="margin-top: 20px;">
        <a href="https://b.indiacybercafe.com/store" style="background: #FF9933; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">Visit Store</a>
      </p>
  ...
  adminNewReview: (productName: string, customerName: string, rating: number, reviewText: string) => baseTemplate(
    ...
    `
      ...
      <p style="margin-top: 20px;">
        <a href="https://b.indiacybercafe.com/admin" style="background: #FF9933; color: white; padding: 12px 30px; border-radius: 5px; text-decoration: none; display: inline-block; font-weight: bold;">Review in Admin Panel</a>
      </p>
